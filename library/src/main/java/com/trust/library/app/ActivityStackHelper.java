...
public class ActivityStackHelper {
    ...
    private static LinkedList<ActivityReference> sStack = new LinkedList<>();
    ...
    public static void finishAllTopActivity(Class<?> clazz) {
        for (ActivityReference ref : sStack) {
            if (ref != null && ref.get() != null) {
                Activity activity = ref.get();
    ...
    public static void finishAllActivityExcept(Class<?> clazz) {
        for (ActivityReference ref : sStack) {
            if (ref != null && ref.get() != null) {
                Activity activity = ref.get();
                if (activity.getClass() == clazz) {
